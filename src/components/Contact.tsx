        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <div>
                <p className="font-mono font-bold text-foreground mb-1">Contact</p>
                <p>Daniel Martin</p>
              </div>
              <div>
                <p className="font-mono font-bold text-foreground mb-1">Address</p>
                <p>595 Market St #200,<br />San Francisco, CA 94105, USA</p>
              </div>
              <div>
                <p className="font-mono font-bold text-foreground mb-1">Phone</p>
                <p>+1(747)229-8269</p>
                <p>+1(858)241-6553</p>
              </div>
            </div>
