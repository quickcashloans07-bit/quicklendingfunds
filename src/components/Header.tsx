    ...
    <header className="border-b border-border bg-background sticky top-0 z-50">
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between gap-4">
        <Link to="/" className="flex items-center hover:opacity-80 transition-opacity flex-shrink-0">
          <img src={quickLendingLogo} alt="Quick Lending Funds - Fast. Reliable. Convenient." className="h-24 md:h-32 lg:h-36 w-auto object-contain flex-shrink-0" loading="eager" />
        </Link>
